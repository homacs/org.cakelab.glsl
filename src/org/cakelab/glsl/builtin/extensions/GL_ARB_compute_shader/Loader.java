...
public class Loader extends GLSLExtensionLoader {
	...
	private static final Macro HAVE_GL_ARB_shader_storage_buffer_object = GLSLBuiltinServices.createMacro("HAVE_GL_ARB_shader_storage_buffer_object", new TNumber("1"));
